	...
	$scope.addFavoris = function(movie) {
      ...
      if (response.status == 226) {
        var alertPopup = $ionicPopup.alert({
          ...
          template: '<div style="text-align: center; margin-top: 10px;"><span>Ce favoris est deja dans votre liste !</span></div>'
        });
        ...
        var alertPopup = $ionicPopup.alert({
          title: 'Ajouter un favoris',
          template: '<div style="text-align: center; margin-top: 10px;"><span>Le favoris a été ajouté !</span></div>'
        });
      }
      console.log(response);
     }, function myError(response) {
